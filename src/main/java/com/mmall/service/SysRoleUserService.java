...
public class SysRoleUserService {
    ...
    public void changeRoleUsers(int roleId,List<Integer> userIdList){
        ...
        updataRoleUsers(roleId,userIdList);
        saveRoleUserLog(roleId,originUserIdList,userIdList);
    }

    @Transactional
    public void updataRoleUsers(int roleId,List<Integer> userIdList){
    ...
    private void saveRoleUserLog(int roleId,List<Integer> befor, List<Integer> after){
