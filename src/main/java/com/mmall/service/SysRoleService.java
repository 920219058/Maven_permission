...
public class SysRoleService {
    ...
    public void save(RoleParam param){
        ...
        SysRole role = SysRole.builder().name(param.getName()).status(param.getStatus()).type(param.getType()).remark(param.getRemark()).build();
    ...
    public void update(RoleParam param){
        ...
        sysLogService.saveRoleLog(befor,after);
    }
